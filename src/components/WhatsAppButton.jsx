...
const WhatsAppButton = () => {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-[999]">
            ...
            >
                {/* Tooltip */}
                <span className="absolute right-full mr-4 bg-black/80 text-white text-sm px-3 py-1 rounded-lg opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity whitespace-nowrap">
